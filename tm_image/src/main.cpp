...
//輸入WIFI連線帳號密碼
const char* ssid     = "Zenfone 10_5867";   //your network SSID
const char* password = "uzptu2p5f66c6mx";   //your network password
...
//  for (int i=0;i<2;i++) {
    ...
    if (WiFi.status() == WL_CONNECTED) {    //若連線成功
      bool ap_ok = WiFi.softAP((WiFi.localIP().toString()+"_"+(String)apssid).c_str(), appassword);   //設定SSID顯示客戶端IP         
